...
while run:
	...
	if game_over == True:
		screen.blit(game_over_img, (screen_width // 2 - 217, screen_height // 2 - 270))
		if button.draw() == True :
			game_over = False
			score = reset_game()
			last_pipe = -pipe_frequency
	...
	for event in pygame.event.get():
		...
		if event.type == pygame.KEYDOWN and event.key == pygame.K_SPACE and flying == True and game_over == False:
			flying = False
